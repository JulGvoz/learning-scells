...
class AlphaColumnSpec extends AnyFlatSpec with Matchers {
  ...
  val hardTests = 19 + 26 * 12 + 26*26 * 7 + 26*26*26 * 10 + 26*26*26*26 * 1 :: // AJGLS
                  ...
                  20 + 26 * 19 + 26*26 * 5 + 26*26*26 * 20 :: Nil // TEST
  val hardAnswers = List("AJGLS", "ZZZZZ", "AAAAA", "TEST")
  ...
  it should "convert ints to length-2 strings" in {
    runTests(harderTests, hardAnswers)(_.toAlpha)
  }
  ...
  "toColumn" should "convert ints [1 - 26] to length-1 strings" in {
